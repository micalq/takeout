<template>
        ...
        <a class="back" @touchend="$router.back()">
        ...
        <i class="content-icon" @touchend="showModel=true"></i>
        </h2>
       ...
       {{shopInfo.description}}
        ...
        <div class="shop-header-discounts" v-if="shopInfo.supports" @touchend="showSupports=true">
        <div class="discounts-left">
        <div class="activity">
        <span class="content-tag" :class="[shopInfo.supports[0].type]">
       ...
       <transition name="fade">
        <div class="shop-brief-modal" v-show="showModel">
        ...
        <span class="iconfont icon-close" @touchend="showModel=false"></span>
        </div>
        </div>
        ...
        <ul class="list">
        <li class="activity-item" :class="supportClasses[item.type]" v-for="(item, index) in shopInfo.supports" :key="index">
        <span class="content-tag">
        ...
        <span class="iconfont icon-close" @touchend="showSupports=false"></span>
        </div>
        </div>
...
export default {
    data() {
        return {
            supportClasses:["activity-green","activity-red","activity-orange"],//样式
            showModel:false,//商家详情信息
            showSupports:false,//商家优惠信息
        }
    },
    computed: {
        ...mapState(["shopInfo"])
