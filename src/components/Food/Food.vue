<template>
    <div class="food" v-if="showFood">
        ...
        <img v-lazy="foods.image">
        <p class="foodpanel-desc">{{foods.info}}</p>
        <div class="back"  @touchend="toggleShow">
       ...
       <CartControl :foods="foods"/>
        </div>
        </div>
        </div>
        <div class="food-cover" @touchend="toggleShow"></div>
</div>
</template>
<script>
